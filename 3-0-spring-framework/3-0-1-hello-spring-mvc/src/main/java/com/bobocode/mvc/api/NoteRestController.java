 ...
 * <p>
 * Both methods work with content type JSON. The endpoi=that returns all notes does not require any input parameters,
...
public class NoteRestController {
    ...
    @PostMapping
    public void addNewNote(@RequestBody final Note note) {
        notes.add(note);
    }
